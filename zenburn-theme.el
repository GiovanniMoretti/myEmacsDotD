...
(setcdr (assoc 'background-color default-frame-alist) zenburn-bg)
(setcdr (assoc 'foreground-color default-frame-alist) zenburn-fg)
(setcdr (assoc 'cursor-color default-frame-alist) zenburn-fg)
